-- Banco isolado do restante do projeto Supabase.
...
CREATE TABLE IF NOT EXISTS configuracoes (
  ...
  valor         TEXT,
  descricao     TEXT,
  atualizado_em TEXT NOT NULL DEFAULT (to_char(CURRENT_TIMESTAMP AT TIME ZONE 'America/Sao_Paulo', 'YYYY-MM-DD HH24:MI:SS'))
);
...
CREATE TABLE IF NOT EXISTS lojas (
  ...
  criado_em     TEXT NOT NULL DEFAULT (to_char(CURRENT_TIMESTAMP AT TIME ZONE 'America/Sao_Paulo', 'YYYY-MM-DD HH24:MI:SS'))
);
...
CREATE TABLE IF NOT EXISTS usuarios (
  ...
  comissao_pct NUMERIC NOT NULL DEFAULT 0,    -- % de comissao padrao
  telefone    TEXT,
...
CREATE TABLE IF NOT EXISTS variacoes (
  ...
  comprimento_valor        NUMERIC,
  comprimento_unidade      TEXT DEFAULT 'cm' CHECK (comprimento_unidade IN ('cm','pol','m')),
  peso_pacote              NUMERIC,             -- gramas
  quantidade_por_pacote    NUMERIC,
  quantidade_recomendada   NUMERIC,             -- pacotes p/ um penteado / cabeca
  publico_id               INTEGER REFERENCES publicos(id),
  observacoes              TEXT,

  -- --- 4. Comercial e precos -------------------------------------------
  custo_aquisicao          NUMERIC NOT NULL DEFAULT 0,
  custo_medio              NUMERIC NOT NULL DEFAULT 0,     -- recalculado pelas entradas
  ultimo_custo             NUMERIC NOT NULL DEFAULT 0,
  preco_venda              NUMERIC NOT NULL DEFAULT 0,
  preco_promocional        NUMERIC,
  preco_minimo_autorizado  NUMERIC,
  data_ultima_alteracao_preco TEXT,
  -- margem/markup calculados pelo banco, nunca digitados
  margem_valor             NUMERIC GENERATED ALWAYS AS (preco_venda - custo_medio) STORED,
  margem_percentual        NUMERIC GENERATED ALWAYS AS
  ...
  estoque_max              NUMERIC NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS produto_fornecedor (
  ...
  custo                NUMERIC,
  qtd_minima_compra    NUMERIC,
  multiplo_compra      NUMERIC,
  prazo_entrega_dias   INTEGER,
  ultima_compra        TEXT,
  ultimo_custo_compra  NUMERIC,
...
CREATE TABLE IF NOT EXISTS estoque (
  ...
  disponivel   NUMERIC GENERATED ALWAYS AS (quantidade - reservado) STORED,
  atualizado_em TEXT NOT NULL DEFAULT (to_char(CURRENT_TIMESTAMP AT TIME ZONE 'America/Sao_Paulo', 'YYYY-MM-DD HH24:MI:SS')),
...
CREATE TABLE IF NOT EXISTS estoque_movimentos (
  ...
  quantidade       NUMERIC NOT NULL,             -- sempre positivo; o tipo define o sinal
...
CREATE TABLE IF NOT EXISTS transferencias (
  ...
  data                TEXT NOT NULL DEFAULT (to_char(CURRENT_TIMESTAMP AT TIME ZONE 'America/Sao_Paulo', 'YYYY-MM-DD HH24:MI:SS')),
...
CREATE TABLE IF NOT EXISTS compras (
  ...
  fornecedor_id   INTEGER NOT NULL REFERENCES fornecedores(id),
  loja_id         INTEGER NOT NULL REFERENCES lojas(id),
  data            TEXT NOT NULL DEFAULT (to_char(CURRENT_TIMESTAMP AT TIME ZONE 'America/Sao_Paulo', 'YYYY-MM-DD')),
...
CREATE TABLE IF NOT EXISTS caixas (
  ...
  abertura_em         TEXT NOT NULL DEFAULT (to_char(CURRENT_TIMESTAMP AT TIME ZONE 'America/Sao_Paulo', 'YYYY-MM-DD HH24:MI:SS')),
  fechamento_em       TEXT,
...
CREATE TABLE IF NOT EXISTS vendas (
  ...
  frete              NUMERIC NOT NULL DEFAULT 0,
  total              NUMERIC NOT NULL DEFAULT 0,
  custo_total        NUMERIC NOT NULL DEFAULT 0,   -- congelado no momento da venda
  lucro              NUMERIC GENERATED ALWAYS AS (total - custo_total) STORED,
  status             TEXT NOT NULL DEFAULT 'concluida'
...
CREATE TABLE IF NOT EXISTS vendas_itens (
  ...
  preco_tabela    NUMERIC,                      -- preco cheio, p/ mostrar o desconto
  desconto_valor  NUMERIC NOT NULL DEFAULT 0,
  total           NUMERIC NOT NULL,
  custo_unitario  NUMERIC NOT NULL DEFAULT 0,
...
-- Sistema de Gestao + PDV  |  Schema relacional (PostgreSQL / Supabase)
--
...
CREATE OR REPLACE VIEW vw_variacoes AS
SELECT
  v.id                       AS variacao_id,
  v.sku,
  v.ean,
...
CREATE OR REPLACE VIEW vw_estoques AS
SELECT
  l.id                    AS loja_id,
  l.nome,
  l.apelido,
...
CREATE OR REPLACE VIEW vw_metricas_variacao AS
SELECT
  vi.variacao_id,
  ...
  CASE WHEN MAX(v.data) IS NULL THEN NULL
       ELSE ((CURRENT_TIMESTAMP AT TIME ZONE 'America/Sao_Paulo')::date - MAX(v.data)::date) END AS dias_sem_venda,
